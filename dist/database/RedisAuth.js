...
var RedisAuth = /** @class */ (function () {
    function RedisAuth() {
    }
    RedisAuth.engine = function () {
        return RedisAuth.redisEngine;
    };
    RedisAuth.connect = function (host, port, db_index) {
    ...
    RedisAuth.get_uinfo_inredis = function (uid) {
        return __awaiter(this, void 0, void 0, function () {
            var key;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        key = auth_center_key + uid;
                        return [4 /*yield*/, RedisAuth.engine().hgetall(key)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    RedisAuth.redisEngine = new RedisEngine_1["default"]();
    return RedisAuth;
}());
