...
var RedisGame = /** @class */ (function () {
    ...
    RedisGame.engine = function () {
        return RedisGame.redisEngine;
    };
    RedisGame.connect = function (host, port, db_index) {
        RedisGame.engine().connect(host, port, db_index);
    };
    //uinfo: table
    RedisGame.set_gameinfo_inredis = function (uid, uinfo) {
    ...
    RedisGame.get_gameinfo_inredis = function (uid) {
        return __awaiter(this, void 0, void 0, function () {
            var key;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        key = game_info_key + uid;
                        return [4 /*yield*/, RedisGame.engine().hgetall(key)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    RedisGame.redisEngine = new RedisEngine_1["default"]();
    return RedisGame;
}());
exports["default"] = RedisGame;
//# sourceMappingURL=RedisGame.js.map