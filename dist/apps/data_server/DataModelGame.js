...
var DataModelGame = /** @class */ (function () {
    function DataModelGame() {
        var _a;
    ...
    DataModelGame.getInstance = function () {
        return DataModelGame.Instance;
    };
    DataModelGame.prototype.decode_cmd = function (proto_type, raw_cmd) {
        return ProtoManager_1["default"].decode_cmd(proto_type, raw_cmd);
    };
    DataModelGame.prototype.recv_cmd_msg = function (session, stype, ctype, utag, proto_type, raw_cmd) {
    ...
    DataModelGame.prototype.on_player_lost_connect = function (session, utag, proto_type, raw_cmd) {
        var body = this.decode_cmd(proto_type, raw_cmd);
        Log_1["default"].info("on_player_lost_connect utag:", utag, body);
    };
    DataModelGame.Instance = new DataModelGame();
    return DataModelGame;
}());
exports["default"] = DataModelGame;
//# sourceMappingURL=DataModelGame.js.map