...
var RobotPlayer_1 = __importDefault(require("./RobotPlayer"));
...
var RobotManager = /** @class */ (function () {
    ...
    RobotManager.getInstance = function () {
    ...
    RobotManager.prototype.get_free_robot_player = function () {
        var player_set = playerMgr.get_player_set();
    ...
    RobotManager.prototype.delete_robot_player = function (uid) {
