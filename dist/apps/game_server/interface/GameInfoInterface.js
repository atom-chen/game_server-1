...
var GameInfoInterface = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (sql_ret) {
                            ...
                            if (ret_len > 0) {
                                try {
                                    ...
                                    player.send_cmd(GameHoodleProto_1["default"].XY_ID.eUserBallInfoRes, body);
                        ...
                        player.send_cmd(GameHoodleProto_1["default"].XY_ID.eUserBallInfoRes, { status: Response_1["default"].INVALIDI_OPT });
                        return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ret = _a.sent();
                        if (ret) {
                            player.send_cmd(GameHoodleProto_1["default"].XY_ID.eUpdateUserBallRes, body_ball);
                            player.set_uball_info(tmp_ball_json);
                            return [2 /*return*/];
                        }
                        _a.label = 3;
                    case 3:
                        player.send_cmd(GameHoodleProto_1["default"].XY_ID.eUpdateUserBallRes, { status: Response_1["default"].INVALIDI_OPT });
                        _a.label = 4;
    ...
    GameInfoInterface.do_player_store_list = function (utag) {
        ...
        player.send_cmd(GameHoodleProto_1["default"].XY_ID.eStoreListRes, res_body);
    };
    //玩家购买
                ...
                switch (_c.label) {
                    ...
                    case 3:
                        ...
                        if (update_ret) {
                            ...
                            player.send_cmd(GameHoodleProto_1["default"].XY_ID.eBuyThingsRes, res_body);
                            return [2 /*return*/];
                        }
                        _c.label = 4;
                    ...
                    case 5:
                        ...
                        return [3 /*break*/, 1];
                    case 6:
                        player.send_cmd(GameHoodleProto_1["default"].XY_ID.eBuyThingsRes, { status: Response_1["default"].INVALIDI_OPT });
                        return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (sql_ret) {
                            ...
                            if (ret_len > 0) {
                                try {
                                    ...
                                    player.send_cmd(GameHoodleProto_1["default"].XY_ID.eUserConfigRes, body);
                        ...
                        player.send_cmd(GameHoodleProto_1["default"].XY_ID.eUserConfigRes, { status: Response_1["default"].INVALIDI_OPT });
                        return [2 /*return*/];
                }
            });
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        player.send_cmd(GameHoodleProto_1["default"].XY_ID.eUseHoodleBallRes, body);
                    ...
                    case 1:
                        ...
                        _a.label = 2;
                    case 2:
                        player.send_cmd(GameHoodleProto_1["default"].XY_ID.eUseHoodleBallRes, { status: Response_1["default"].INVALIDI_OPT });
                        return [2 /*return*/];
                }
            });
        });
