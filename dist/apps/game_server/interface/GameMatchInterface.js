...
var GameMatchInterface = /** @class */ (function () {
    ...
    GameMatchInterface.do_player_match = function (utag, proto_type, raw_cmd) {
        ...
        if (room) {
            ...
            player.send_cmd(GameHoodleProto_1["default"].XY_ID.eUserMatchRes, { status: Response_1["default"].INVALIDI_OPT });
            return;
        }
        ...
        if (!ret) {
            ...
            player.send_cmd(GameHoodleProto_1["default"].XY_ID.eUserMatchRes, { status: Response_1["default"].NOT_YOUR_TURN });
            return;
        }
        //发送匹配信息
        var userinfo_array = [];
    ...
    GameMatchInterface.do_player_stop_match = function (utag) {
        ...
        if (!ret) {
            ...
            player.send_cmd(GameHoodleProto_1["default"].XY_ID.eUserStopMatchRes, { status: Response_1["default"].INVALIDI_OPT });
            return;
        }
        player.send_cmd(GameHoodleProto_1["default"].XY_ID.eUserStopMatchRes, { status: Response_1["default"].OK });
