...
var GameLinkInterface = /** @class */ (function () {
    ...
    GameLinkInterface._player_lost_connect = function (player) {
        ...
        if (room) {
            ...
            room.broadcast_in_room(GameHoodleProto_1["default"].XY_ID.eUserOfflineRes, { seatid: player.get_seat_id() }, player);
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (issuccess) {
                            ...
                            player.send_cmd(GameHoodleProto_1["default"].XY_ID.eLoginLogicRes, { status: Response_1["default"].OK });
                        }
                        else {
                            player.send_cmd(GameHoodleProto_1["default"].XY_ID.eLoginLogicRes, { status: Response_1["default"].SYSTEM_ERR });
                        }
                        return [3 /*break*/, 7];
                    case 2:
                    ...
                    case 6:
                        ...
                        if (newPlayer) {
                            ...
                            newPlayer.send_cmd(GameHoodleProto_1["default"].XY_ID.eLoginLogicRes, { status: Response_1["default"].OK });
                        }
                        else {
