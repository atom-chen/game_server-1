...
var GameLinkInterface = /** @class */ (function () {
    ...
    GameLinkInterface.do_player_login_logic_server = function (session, utag, proto_type, raw_cmd) {
        return __awaiter(this, void 0, void 0, function () {
            var player, issuccess, room, body, newPlayer, room;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        GameSendMsg_1["default"].send(session, GameHoodleProto_1["default"].XY_ID.eLoginLogicRes, utag, proto_type, { status: Response_1["default"].OK });
                    ...
                    case 2:
                        room = _a.sent();
                        if (room) {
                            GameFunction_1["default"].broadcast_player_info_in_rooom(room, player.get_uid());
                        }
                        return [2 /*return*/];
                    ...
                    case 4:
                        ...
                        newPlayer = null;
                        if (!(body && body.isrobot == true)) return [3 /*break*/, 6];
                        return [4 /*yield*/, RobotManager_1["default"].getInstance().alloc_robot_player(session, utag, proto_type)];
                    case 5:
                        newPlayer = _a.sent();
                        return [3 /*break*/, 8];
                    case 6: return [4 /*yield*/, playerMgr.alloc_player(session, utag, proto_type)];
                    case 7:
                        newPlayer = _a.sent();
                        _a.label = 8;
                    case 8:
                        Log_1["default"].info("hcc>> new player success!!! , isrobot: ", newPlayer.is_robot(), " ,uid:", newPlayer.get_uid());
                        if (!newPlayer) return [3 /*break*/, 10];
                        GameSendMsg_1["default"].send(session, GameHoodleProto_1["default"].XY_ID.eLoginLogicRes, utag, proto_type, { status: Response_1["default"].OK });
                        RedisLobby_1["default"].set_server_playercount(GameServerData_1["default"].get_server_key(), playerMgr.get_player_count());
                        return [4 /*yield*/, newPlayer.get_room()];
                    case 9:
                        room = _a.sent();
                        if (room) {
                            GameFunction_1["default"].broadcast_player_info_in_rooom(room, newPlayer.get_uid());
                        }
                        return [2 /*return*/];
                    case 10:
                        GameSendMsg_1["default"].send(session, GameHoodleProto_1["default"].XY_ID.eLoginLogicRes, utag, proto_type, { status: Response_1["default"].SYSTEM_ERR });
                        return [2 /*return*/];
                }
            });
        });
