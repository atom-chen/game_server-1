...
class NetServer {
    ...
    //开启webserver
    static start_ws_server(ip: string, port: number, is_encrypt: boolean, client_enter_func?: Function, start_successc_func?: Function) {
    ...
    //开启tcpserver
    static start_tcp_server(ip: string, port: number, is_encrypt: boolean, client_enter_func?: Function, start_successc_func?: Function) {
