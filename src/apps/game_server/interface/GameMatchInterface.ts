...
class GameMatchInterface {
    ...
    static do_player_match(utag:number,proto_type:number, raw_cmd:any){
        ...
        if (room) {
            ...
            player.send_cmd(GameHoodleProto.XY_ID.eUserMatchRes, { status: Response.INVALIDI_OPT });
            return;
        }
        ...
        if (!ret) {
            ...
            player.send_cmd(GameHoodleProto.XY_ID.eUserMatchRes, { status: Response.NOT_YOUR_TURN });
            return;
        }
    ...
    */
    ...
    static do_player_stop_match(utag:number){
        ...
        if (!ret) {
            ...
            player.send_cmd(GameHoodleProto.XY_ID.eUserStopMatchRes, { status: Response.INVALIDI_OPT });
            return;
        }
